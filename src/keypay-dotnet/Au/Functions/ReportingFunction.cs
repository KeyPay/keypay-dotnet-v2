...
namespace KeyPayV2.Au.Functions
{
    ...
    public class ReportingFunction : BaseFunction, IReportingFunction
    {
        ...
        {
            return ApiRequest<List<ActivityReportExportModel>>($"/business/{businessId}/report/payrunactivity{ToQueryString("fromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "toDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "payScheduleId=" + request.PayScheduleId, "locationId=" + request.LocationId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<ActivityReportExportModel>>($"/business/{businessId}/report/payrunactivity{ToQueryString("fromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "toDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "payScheduleId=" + request.PayScheduleId, "locationId=" + request.LocationId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<AuCostingReportApiModel>>($"/business/{businessId}/report/costing{ToQueryString("ShowZeroPayCategories=" + request.ShowZeroPayCategories, "PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<AuCostingReportApiModel>>($"/business/{businessId}/report/costing{ToQueryString("ShowZeroPayCategories=" + request.ShowZeroPayCategories, "PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<AuDetailedActivityReportExportModel>>($"/business/{businessId}/report/detailedactivity{ToQueryString("PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<AuDetailedActivityReportExportModel>>($"/business/{businessId}/report/detailedactivity{ToQueryString("PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequestAsync<List<AuLeaveLiabilityExportModel>>($"/business/{businessId}/report/leaveliability{ToQueryString("JobId=" + request.JobId, "FilterType=" + request.FilterType, "LocationId=" + request.LocationId, "LeaveTypeId=" + request.LeaveTypeId, "IncludeApprovedLeave=" + request.IncludeApprovedLeave, "AsAtDate=" + (request.AsAtDate.HasValue ? request.AsAtDate.Value.ToString("yyyy-MM-ddTHH:mm:ss") : String.Empty), "EmployingEntityId=" + request.EmployingEntityId, "PayRunId=" + request.PayRunId, QsArr("LeaveTypeIds", request.LeaveTypeIds?.Select(x => x.ToString())), "GroupBy=" + request.GroupBy, "PayScheduleId=" + request.PayScheduleId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<AuOrdinaryTimeEarningsApiModel>>($"/business/{businessId}/report/ordinarytimeearnings{ToQueryString("PayScheduleId=" + request.PayScheduleId, "EmployingEntityId=" + request.EmployingEntityId, "FinancialYearEnding=" + request.FinancialYearEnding)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<AuOrdinaryTimeEarningsApiModel>>($"/business/{businessId}/report/ordinarytimeearnings{ToQueryString("PayScheduleId=" + request.PayScheduleId, "EmployingEntityId=" + request.EmployingEntityId, "FinancialYearEnding=" + request.FinancialYearEnding)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<AuPayCategoriesModel>>($"/business/{businessId}/report/paycategories{ToQueryString("PayScheduleId=" + request.PayScheduleId, "EmployeeId=" + request.EmployeeId, "GroupByEarningsLocation=" + request.GroupByEarningsLocation, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<AuPayCategoriesModel>>($"/business/{businessId}/report/paycategories{ToQueryString("PayScheduleId=" + request.PayScheduleId, "EmployeeId=" + request.EmployeeId, "GroupByEarningsLocation=" + request.GroupByEarningsLocation, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<AuPaymentHistoryModel>>($"/business/{businessId}/report/paymenthistory{ToQueryString("EmployeeId=" + request.EmployeeId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<AuPaymentHistoryModel>>($"/business/{businessId}/report/paymenthistory{ToQueryString("EmployeeId=" + request.EmployeeId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<AuQualifyingEarningsReportExportModel>>($"/business/{businessId}/report/qualifyingearnings{ToQueryString("PayRunId=" + request.PayRunId, "PayScheduleId=" + request.PayScheduleId, "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), QsArr("EmployeeIds", request.EmployeeIds?.Select(x => x.ToString())))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<AuQualifyingEarningsReportExportModel>>($"/business/{businessId}/report/qualifyingearnings{ToQueryString("PayRunId=" + request.PayRunId, "PayScheduleId=" + request.PayScheduleId, "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), QsArr("EmployeeIds", request.EmployeeIds?.Select(x => x.ToString())))}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<PaygReportExportModel>>($"/business/{businessId}/report/payg{ToQueryString("State=" + request.State, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<PaygReportExportModel>>($"/business/{businessId}/report/payg{ToQueryString("State=" + request.State, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<SuperAccrualExportModel>>($"/business/{businessId}/report/supercontributions/byemployee{ToQueryString("PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<SuperAccrualExportModel>>($"/business/{businessId}/report/supercontributions/byemployee{ToQueryString("PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<SuperContributionsReportExportModel>>($"/business/{businessId}/report/supercontributions/bysuperfund{ToQueryString("PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<SuperContributionsReportExportModel>>($"/business/{businessId}/report/supercontributions/bysuperfund{ToQueryString("PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiByteArrayRequest($"/business/{businessId}/report/qualifyingearnings/csv{ToQueryString("PayRunId=" + request.PayRunId, "PayScheduleId=" + request.PayScheduleId, "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), QsArr("EmployeeIds", request.EmployeeIds?.Select(x => x.ToString())))}", Method.Get);
        }
        ...
        {
            return ApiByteArrayRequestAsync($"/business/{businessId}/report/qualifyingearnings/csv{ToQueryString("PayRunId=" + request.PayRunId, "PayScheduleId=" + request.PayScheduleId, "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), QsArr("EmployeeIds", request.EmployeeIds?.Select(x => x.ToString())))}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiByteArrayRequest($"/business/{businessId}/report/qualifyingearnings/xlsx{ToQueryString("PayRunId=" + request.PayRunId, "PayScheduleId=" + request.PayScheduleId, "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), QsArr("EmployeeIds", request.EmployeeIds?.Select(x => x.ToString())))}", Method.Get);
        }
        ...
        {
            return ApiByteArrayRequestAsync($"/business/{businessId}/report/qualifyingearnings/xlsx{ToQueryString("PayRunId=" + request.PayRunId, "PayScheduleId=" + request.PayScheduleId, "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), QsArr("EmployeeIds", request.EmployeeIds?.Select(x => x.ToString())))}", Method.Get, cancellationToken);
        }
