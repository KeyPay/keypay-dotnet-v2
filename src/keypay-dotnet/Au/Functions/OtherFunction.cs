...
namespace KeyPayV2.Au.Functions
{
    public interface IOtherFunction
    {
        ...
        UserAccessModel AuOnboardEmployee_CheckUserAccess(int businessId, int employeeId, AuOnboardEmployee_CheckUserAccessQueryModel request);
        Task<UserAccessModel> AuOnboardEmployee_CheckUserAccessAsync(int businessId, int employeeId, AuOnboardEmployee_CheckUserAccessQueryModel request, CancellationToken cancellationToken = default);
    ...
    public class OtherFunction : BaseFunction, IOtherFunction
    {
        ...
        public UserAccessModel AuOnboardEmployee_CheckUserAccess(int businessId, int employeeId, AuOnboardEmployee_CheckUserAccessQueryModel request)
        {
            return ApiRequest<UserAccessModel>($"/business/{businessId}/employee/{employeeId}/userAccess?email={request.Email}", Method.Get);
        }

        public Task<UserAccessModel> AuOnboardEmployee_CheckUserAccessAsync(int businessId, int employeeId, AuOnboardEmployee_CheckUserAccessQueryModel request, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UserAccessModel>($"/business/{businessId}/employee/{employeeId}/userAccess?email={request.Email}", Method.Get, cancellationToken);
        }
