...
namespace KeyPayV2.Au.Functions
{
    ...
    public class BrandFunction : BaseFunction, IBrandFunction
    {
        ...
        /// </remarks>
        public List<AuActiveEmployeesModel> ActiveEmployeesReport(int brandId)
        {
            return ApiRequest<List<AuActiveEmployeesModel>>($"/brand/{brandId}/reports/activeemployees", Method.Get);
        }
        ...
        /// Brand Active Employees Report
        /// </remarks>
        public Task<List<AuActiveEmployeesModel>> ActiveEmployeesReportAsync(int brandId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<List<AuActiveEmployeesModel>>($"/brand/{brandId}/reports/activeemployees", Method.Get, cancellationToken);
        }
