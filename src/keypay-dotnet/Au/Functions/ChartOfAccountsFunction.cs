...
namespace KeyPayV2.Au.Functions
{
    public class ChartOfAccountsFunction : BaseFunction
    {
        ...
        {
            return ApiRequest<AuChartOfAccountsModel>($"/business/{businessId}/chartofaccounts");
        }
        ...
        {
            return ApiRequest<AuChartOfAccountsLocationGroupModel>($"/business/{businessId}/chartofaccounts/location/{locationId}");
        }
