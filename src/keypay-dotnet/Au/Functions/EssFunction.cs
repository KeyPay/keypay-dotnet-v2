...
namespace KeyPayV2.Au.Functions
{
    public interface IEssFunction
    {
        ...
        List<AddressAutocompleteModel> AuEssLookup_Addresses(int employeeId, int suburbId);
        Task<List<AddressAutocompleteModel>> AuEssLookup_AddressesAsync(int employeeId, int suburbId, CancellationToken cancellationToken = default);
    ...
    public class EssFunction : BaseFunction, IEssFunction
    {
        ...
        public List<AddressAutocompleteModel> AuEssLookup_Addresses(int employeeId, int suburbId)
        {
            return ApiRequest<List<AddressAutocompleteModel>>($"/ess/{employeeId}/lookup/addresses/{suburbId}", Method.Get);
        }

        public Task<List<AddressAutocompleteModel>> AuEssLookup_AddressesAsync(int employeeId, int suburbId, CancellationToken cancellationToken = default)
        {
