...
namespace KeyPayV2.Au.Functions
{
    public class TimesheetsFunction : BaseFunction
    {
        ...
        /// </remarks>
        public AuSubmitTimesheetsRequest UpdateReplaceTimesheets(int businessId, AuSubmitTimesheetsRequest request)
        {
            return ApiRequest<AuSubmitTimesheetsRequest,AuSubmitTimesheetsRequest>($"/business/{businessId}/timesheet/bulk", request, Method.PUT);
        }
        ...
        /// </remarks>
        public AuSubmitTimesheetsRequest BulkInsertTimesheets(int businessId, AuSubmitTimesheetsRequest request)
        {
            return ApiRequest<AuSubmitTimesheetsRequest,AuSubmitTimesheetsRequest>($"/business/{businessId}/timesheet/bulk", request, Method.POST);
        }
    }
}
