...
namespace KeyPayV2.Nz.Functions
{
    ...
    {
        NzBusinessAdvancedSettingsModel GetBusinessAdvancedSettings(int businessId);
        Task<NzBusinessAdvancedSettingsModel> GetBusinessAdvancedSettingsAsync(int businessId, CancellationToken cancellationToken = default);
        NzBusinessAdvancedSettingsModel UpdateBusinessAdvancedSettings(int businessId, NzBusinessAdvancedSettingsModel model);
        Task<NzBusinessAdvancedSettingsModel> UpdateBusinessAdvancedSettingsAsync(int businessId, NzBusinessAdvancedSettingsModel model, CancellationToken cancellationToken = default);
    ...
    public class OtherFunction : BaseFunction, IOtherFunction
    {
        ...
        /// </summary>
        public NzBusinessAdvancedSettingsModel GetBusinessAdvancedSettings(int businessId)
        {
            return ApiRequest<NzBusinessAdvancedSettingsModel>($"/business/{businessId}/advanced", Method.Get);
        }

        /// <summary>
        /// Get business advanced settings
        /// </summary>
        public Task<NzBusinessAdvancedSettingsModel> GetBusinessAdvancedSettingsAsync(int businessId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<NzBusinessAdvancedSettingsModel>($"/business/{businessId}/advanced", Method.Get, cancellationToken);
        }

        /// <summary>
        /// Update business advanced settings
        /// </summary>
        public NzBusinessAdvancedSettingsModel UpdateBusinessAdvancedSettings(int businessId, NzBusinessAdvancedSettingsModel model)
        {
            return ApiRequest<NzBusinessAdvancedSettingsModel,NzBusinessAdvancedSettingsModel>($"/business/{businessId}/advanced", model, Method.Put);
        }

        /// <summary>
        /// Update business advanced settings
        /// </summary>
        public Task<NzBusinessAdvancedSettingsModel> UpdateBusinessAdvancedSettingsAsync(int businessId, NzBusinessAdvancedSettingsModel model, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<NzBusinessAdvancedSettingsModel,NzBusinessAdvancedSettingsModel>($"/business/{businessId}/advanced", model, Method.Put, cancellationToken);
        }
