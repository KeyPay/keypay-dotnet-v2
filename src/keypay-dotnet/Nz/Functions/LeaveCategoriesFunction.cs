...
namespace KeyPayV2.Nz.Functions
{
    ...
    public class LeaveCategoriesFunction : BaseFunction, ILeaveCategoriesFunction
    {
        ...
        /// </remarks>
        public NzBusinessHolidayLeaveSettingsApiDetailModel SetHolidayLeaveSettings(int businessId, NzBusinessHolidayLeaveSettingsApiModel model)
        {
            return ApiRequest<NzBusinessHolidayLeaveSettingsApiDetailModel,NzBusinessHolidayLeaveSettingsApiModel>($"/business/{businessId}/holidayleavesettings", model, Method.Put);
        }
