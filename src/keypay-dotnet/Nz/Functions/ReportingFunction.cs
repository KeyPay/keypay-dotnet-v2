...
namespace KeyPayV2.Nz.Functions
{
    ...
    public class ReportingFunction : BaseFunction, IReportingFunction
    {
        ...
        {
            return ApiRequest<List<KiwiSaverReportExportModel>>($"/business/{businessId}/report/kiwisaver{ToQueryString("EmployeeId=" + request.EmployeeId, "PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<KiwiSaverReportExportModel>>($"/business/{businessId}/report/kiwisaver{ToQueryString("EmployeeId=" + request.EmployeeId, "PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequestAsync<List<LeaveLiabilityExportModel>>($"/business/{businessId}/report/leaveliability{ToQueryString(QsArr("EmployeeIds", request.EmployeeIds?.Select(x => x.ToString())), "JobId=" + request.JobId, "FilterType=" + request.FilterType, "LocationId=" + request.LocationId, "LeaveTypeId=" + request.LeaveTypeId, "IncludeApprovedLeave=" + request.IncludeApprovedLeave, "AsAtDate=" + (request.AsAtDate.HasValue ? request.AsAtDate.Value.ToString("yyyy-MM-ddTHH:mm:ss") : String.Empty), "EmployingEntityId=" + request.EmployingEntityId, "PayRunId=" + request.PayRunId, QsArr("LeaveTypeIds", request.LeaveTypeIds?.Select(x => x.ToString())), "GroupBy=" + request.GroupBy, "PayScheduleId=" + request.PayScheduleId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<NzCostingReportApiModel>>($"/business/{businessId}/report/costing{ToQueryString("ShowZeroPayCategories=" + request.ShowZeroPayCategories, "PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<NzCostingReportApiModel>>($"/business/{businessId}/report/costing{ToQueryString("ShowZeroPayCategories=" + request.ShowZeroPayCategories, "PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<NzDetailedActivityReportExportModel>>($"/business/{businessId}/report/detailedactivity{ToQueryString("PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<NzDetailedActivityReportExportModel>>($"/business/{businessId}/report/detailedactivity{ToQueryString("PayScheduleId=" + request.PayScheduleId, "IncludePostTaxDeductions=" + request.IncludePostTaxDeductions, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<NzLeaveBalancesExportModel>>($"/business/{businessId}/report/leavebalances{ToQueryString("PayScheduleId=" + request.PayScheduleId, QsArr("EmployeeIds", request.EmployeeIds?.Select(x => x.ToString())), "LocationId=" + request.LocationId, "LeaveTypeId=" + request.LeaveTypeId, "GroupBy=" + request.GroupBy, "EmployingEntityId=" + request.EmployingEntityId, "AsAtDate=" + (request.AsAtDate.HasValue ? request.AsAtDate.Value.ToString("yyyy-MM-ddTHH:mm:ss") : String.Empty))}", Method.Get);
        }
        ...
        {
            return ApiRequest<List<NzOrdinaryTimeEarningsApiModel>>($"/business/{businessId}/report/ordinarytimeearnings{ToQueryString("PayScheduleId=" + request.PayScheduleId, "EmployingEntityId=" + request.EmployingEntityId, "FinancialYearEnding=" + request.FinancialYearEnding)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<NzOrdinaryTimeEarningsApiModel>>($"/business/{businessId}/report/ordinarytimeearnings{ToQueryString("PayScheduleId=" + request.PayScheduleId, "EmployingEntityId=" + request.EmployingEntityId, "FinancialYearEnding=" + request.FinancialYearEnding)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<NzPayCategoriesModel>>($"/business/{businessId}/report/paycategories{ToQueryString("PayScheduleId=" + request.PayScheduleId, "EmployeeId=" + request.EmployeeId, "GroupByEarningsLocation=" + request.GroupByEarningsLocation, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<NzPayCategoriesModel>>($"/business/{businessId}/report/paycategories{ToQueryString("PayScheduleId=" + request.PayScheduleId, "EmployeeId=" + request.EmployeeId, "GroupByEarningsLocation=" + request.GroupByEarningsLocation, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<NzPaymentHistoryModel>>($"/business/{businessId}/report/paymenthistory{ToQueryString("EmployeeId=" + request.EmployeeId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<NzPaymentHistoryModel>>($"/business/{businessId}/report/paymenthistory{ToQueryString("EmployeeId=" + request.EmployeeId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<PayeReportExportModel>>($"/business/{businessId}/report/paye{ToQueryString("State=" + request.State, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<PayeReportExportModel>>($"/business/{businessId}/report/paye{ToQueryString("State=" + request.State, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
        ...
        {
            ApiRequest($"/business/{businessId}/report/kiwisaver/xlsx{ToQueryString("FilterType=" + request.FilterType, "PayScheduleId=" + request.PayScheduleId, "EmployeeId=" + request.EmployeeId, "PayRunId=" + request.PayRunId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync($"/business/{businessId}/report/kiwisaver/xlsx{ToQueryString("FilterType=" + request.FilterType, "PayScheduleId=" + request.PayScheduleId, "EmployeeId=" + request.EmployeeId, "PayRunId=" + request.PayRunId, "FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "LocationId=" + request.LocationId, "EmployingEntityId=" + request.EmployingEntityId)}", Method.Get, cancellationToken);
        }
    }
}
