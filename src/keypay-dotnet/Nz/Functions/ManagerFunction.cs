...
namespace KeyPayV2.Nz.Functions
{
    public class ManagerFunction : BaseFunction
    {
        ...
        /// details provided.
        /// </remarks>
        public Task InitiateEmployeeSelfServiceOnboardingAsync(int businessId, NzInitiateEmployeeOnboardingApiModel model, CancellationToken cancellationToken = default)
        {
