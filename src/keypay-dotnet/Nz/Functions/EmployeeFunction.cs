...
namespace KeyPayV2.Nz.Functions
{
    public interface IEmployeeFunction
    {
        ...
        EmployeeUpdateResponseModel CreateOrUpdateEmployee(int businessId);
        Task<EmployeeUpdateResponseModel> CreateOrUpdateEmployeeAsync(int businessId, CancellationToken cancellationToken = default);
        EmployeeUpdateResponseModel CreateOrUpdateEmployee(int businessId, CreateOrUpdateEmployeeQueryModel request);
        Task<EmployeeUpdateResponseModel> CreateOrUpdateEmployeeAsync(int businessId, CreateOrUpdateEmployeeQueryModel request, CancellationToken cancellationToken = default);
    ...
    public class EmployeeFunction : BaseFunction, IEmployeeFunction
    {
        ...
        ///             taxCodeDeclaration_IrdNumber, taxCodeDeclaration_EsctRate, kiwiSaver_EnrollmentStatus.
        ...
        ///             </p>
        /// </remarks>
        public EmployeeUpdateResponseModel CreateOrUpdateEmployee(int businessId)
        {
            return ApiRequest<EmployeeUpdateResponseModel>($"/business/{businessId}/employee/unstructured", Method.Post);
        }
        ...
        ///             </p>
        /// </remarks>
        public Task<EmployeeUpdateResponseModel> CreateOrUpdateEmployeeAsync(int businessId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<EmployeeUpdateResponseModel>($"/business/{businessId}/employee/unstructured", Method.Post, cancellationToken);
        }
        ...
        ///             </p>
        /// </remarks>
        public EmployeeUpdateResponseModel CreateOrUpdateEmployee(int businessId, CreateOrUpdateEmployeeQueryModel request)
        {
            return ApiRequest<EmployeeUpdateResponseModel>($"/business/{businessId}/employee/unstructured?model={request.Model}&matchType={request.MatchType}", Method.Post);
        }
        ...
        ///             </p>
        /// </remarks>
        public Task<EmployeeUpdateResponseModel> CreateOrUpdateEmployeeAsync(int businessId, CreateOrUpdateEmployeeQueryModel request, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<EmployeeUpdateResponseModel>($"/business/{businessId}/employee/unstructured?model={request.Model}&matchType={request.MatchType}", Method.Post, cancellationToken);
        }
