...
namespace KeyPayV2.Nz.Functions
{
    public interface IEmployeeLeaveAllowancesFunction
    {
        ...
        void SetLeaveAllowances(int businessId, int employeeId, IEnumerable<NzLeaveAllowanceModel> leaveAllowances);
        Task SetLeaveAllowancesAsync(int businessId, int employeeId, IEnumerable<NzLeaveAllowanceModel> leaveAllowances, CancellationToken cancellationToken = default);
    }
    public class EmployeeLeaveAllowancesFunction : BaseFunction, IEmployeeLeaveAllowancesFunction
    {
        ...
        /// </remarks>
        public void SetLeaveAllowances(int businessId, int employeeId, IEnumerable<NzLeaveAllowanceModel> leaveAllowances)
        {
        ...
        /// Sets the leave allowances for the specified employee
        /// </remarks>
        public Task SetLeaveAllowancesAsync(int businessId, int employeeId, IEnumerable<NzLeaveAllowanceModel> leaveAllowances, CancellationToken cancellationToken = default)
        {
