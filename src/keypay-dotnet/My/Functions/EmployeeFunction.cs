...
namespace KeyPayV2.My.Functions
{
    public interface IEmployeeFunction
    {
        ...
        List<WorkTypeModel> GetEmployeeShiftConditions(int businessId, int employeeId, ODataQuery oDataQuery = null);
        Task<List<WorkTypeModel>> GetEmployeeShiftConditionsAsync(int businessId, int employeeId, ODataQuery oDataQuery = null, CancellationToken cancellationToken = default);
        ...
        List<WorkTypeModel> GetEmployeeWorkTypes(int businessId, int employeeId, ODataQuery oDataQuery = null);
        Task<List<WorkTypeModel>> GetEmployeeWorkTypesAsync(int businessId, int employeeId, ODataQuery oDataQuery = null, CancellationToken cancellationToken = default);
        ...
        List<MyUnstructuredEmployeeModel> ListEmployees(int businessId, string options, ODataQuery oDataQuery = null);
        Task<List<MyUnstructuredEmployeeModel>> ListEmployeesAsync(int businessId, string options, ODataQuery oDataQuery = null, CancellationToken cancellationToken = default);
        List<MyUnstructuredEmployeeModel> ListEmployees(int businessId, string options, ListEmployeesQueryModel request, ODataQuery oDataQuery = null);
        Task<List<MyUnstructuredEmployeeModel>> ListEmployeesAsync(int businessId, string options, ListEmployeesQueryModel request, ODataQuery oDataQuery = null, CancellationToken cancellationToken = default);
    ...
    public class EmployeeFunction : BaseFunction, IEmployeeFunction
    {
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<MyUnstructuredEmployeeModel> ListEmployees(int businessId, string options, ODataQuery oDataQuery = null)
        {
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public Task<List<MyUnstructuredEmployeeModel>> ListEmployeesAsync(int businessId, string options, ODataQuery oDataQuery = null, CancellationToken cancellationToken = default)
        {
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<MyUnstructuredEmployeeModel> ListEmployees(int businessId, string options, ListEmployeesQueryModel request, ODataQuery oDataQuery = null)
        {
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public Task<List<MyUnstructuredEmployeeModel>> ListEmployeesAsync(int businessId, string options, ListEmployeesQueryModel request, ODataQuery oDataQuery = null, CancellationToken cancellationToken = default)
        {
