...
namespace KeyPayV2.My.Functions
{
    public interface IEssFunction
    {
        ...
        List<MyEssFormModel> GetPcb2Forms(int employeeId);
        Task<List<MyEssFormModel>> GetPcb2FormsAsync(int employeeId, CancellationToken cancellationToken = default);
        List<MyEssRosterShiftModel> FindNearbyRosterShifts(int employeeId);
        Task<List<MyEssRosterShiftModel>> FindNearbyRosterShiftsAsync(int employeeId, CancellationToken cancellationToken = default);
        ...
        List<MyEssRosterShiftModel> ListRosterShifts(int employeeId);
        Task<List<MyEssRosterShiftModel>> ListRosterShiftsAsync(int employeeId, CancellationToken cancellationToken = default);
        ...
        MyAcceptRosterShiftResponseModel AcceptRosterShift(int employeeId, int rosterShiftId);
        Task<MyAcceptRosterShiftResponseModel> AcceptRosterShiftAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default);
        ...
        MyEssRosterShiftActionResponse AcceptShiftSwap(int employeeId, int rosterShiftId);
        Task<MyEssRosterShiftActionResponse> AcceptShiftSwapAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default);
        MyEssRosterShiftActionResponse CancelShiftSwap(int employeeId, int rosterShiftId);
        Task<MyEssRosterShiftActionResponse> CancelShiftSwapAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default);
        MyEssRosterShiftActionResponse DeclineShiftSwap(int employeeId, int rosterShiftId);
        Task<MyEssRosterShiftActionResponse> DeclineShiftSwapAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default);
        ...
        MyEssRosterShiftModel GetRosterShiftById(int employeeId, int rosterShiftId);
        Task<MyEssRosterShiftModel> GetRosterShiftByIdAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default);
        ...
        MyRosterShiftMatchingResultModel FindMatchingClockOffRosterShift(int employeeId);
        Task<MyRosterShiftMatchingResultModel> FindMatchingClockOffRosterShiftAsync(int employeeId, CancellationToken cancellationToken = default);
        ...
        MyRosterShiftMatchingResultModel FindMatchingClockOnRosterShift(int employeeId);
        Task<MyRosterShiftMatchingResultModel> FindMatchingClockOnRosterShiftAsync(int employeeId, CancellationToken cancellationToken = default);
        ...
        byte[] DownloadEaForm(int employeeId, int documentId);
        Task<byte[]> DownloadEaFormAsync(int employeeId, int documentId, CancellationToken cancellationToken = default);
        byte[] DownloadPcb2Form(int employeeId, int documentId);
        Task<byte[]> DownloadPcb2FormAsync(int employeeId, int documentId, CancellationToken cancellationToken = default);
    ...
    public class EssFunction : BaseFunction, IEssFunction
    {
        ...
        /// </summary>
        /// <remarks>
        /// List all the employee's published PCB2 Forms.
        /// </remarks>
        public List<MyEssFormModel> GetPcb2Forms(int employeeId)
        {
        ...
        /// List all the employee's published PCB2 Forms.
        /// </remarks>
        public Task<List<MyEssFormModel>> GetPcb2FormsAsync(int employeeId, CancellationToken cancellationToken = default)
        {
        ...
        /// </remarks>
        public List<MyEssRosterShiftModel> FindNearbyRosterShifts(int employeeId)
        {
            return ApiRequest<List<MyEssRosterShiftModel>>($"/ess/{employeeId}/shift/nearby", Method.Get);
        }
        ...
        /// Finds any of the employee's roster shifts that are nearby to the specified local time.
        /// </remarks>
        public Task<List<MyEssRosterShiftModel>> FindNearbyRosterShiftsAsync(int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<List<MyEssRosterShiftModel>>($"/ess/{employeeId}/shift/nearby", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<MyEssRosterShiftModel>>($"/ess/{employeeId}/shift/nearby{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<MyEssRosterShiftModel>>($"/ess/{employeeId}/shift/nearby{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public List<MyEssRosterShiftModel> ListRosterShifts(int employeeId)
        {
            return ApiRequest<List<MyEssRosterShiftModel>>($"/ess/{employeeId}/shift", Method.Get);
        }
        ...
        /// Gets the employee's roster shifts within the date range.
        /// </remarks>
        public Task<List<MyEssRosterShiftModel>> ListRosterShiftsAsync(int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<List<MyEssRosterShiftModel>>($"/ess/{employeeId}/shift", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<MyEssRosterShiftModel>>($"/ess/{employeeId}/shift{ToQueryString("fromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "toDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<MyEssRosterShiftModel>>($"/ess/{employeeId}/shift{ToQueryString("fromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "toDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public MyAcceptRosterShiftResponseModel AcceptRosterShift(int employeeId, int rosterShiftId)
        {
            return ApiRequest<MyAcceptRosterShiftResponseModel>($"/ess/{employeeId}/shift/{rosterShiftId}/accept", Method.Post);
        }
        ...
        /// Accepts the roster shift with the specified ID.
        /// </remarks>
        public Task<MyAcceptRosterShiftResponseModel> AcceptRosterShiftAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<MyAcceptRosterShiftResponseModel>($"/ess/{employeeId}/shift/{rosterShiftId}/accept", Method.Post, cancellationToken);
        }
        ...
        /// Accept a shift swap
        /// </remarks>
        public MyEssRosterShiftActionResponse AcceptShiftSwap(int employeeId, int rosterShiftId)
        {
            return ApiRequest<MyEssRosterShiftActionResponse>($"/ess/{employeeId}/shift/{rosterShiftId}/swap/accept", Method.Post);
        }
        ...
        /// Accept a shift swap
        /// </remarks>
        public Task<MyEssRosterShiftActionResponse> AcceptShiftSwapAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<MyEssRosterShiftActionResponse>($"/ess/{employeeId}/shift/{rosterShiftId}/swap/accept", Method.Post, cancellationToken);
        }
        ...
        /// Cancel a shift swap
        /// </remarks>
        public MyEssRosterShiftActionResponse CancelShiftSwap(int employeeId, int rosterShiftId)
        {
            return ApiRequest<MyEssRosterShiftActionResponse>($"/ess/{employeeId}/shift/{rosterShiftId}/swap/cancel", Method.Post);
        }
        ...
        /// Cancel a shift swap
        /// </remarks>
        public Task<MyEssRosterShiftActionResponse> CancelShiftSwapAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<MyEssRosterShiftActionResponse>($"/ess/{employeeId}/shift/{rosterShiftId}/swap/cancel", Method.Post, cancellationToken);
        }
        ...
        /// </remarks>
        public MyEssRosterShiftActionResponse DeclineShiftSwap(int employeeId, int rosterShiftId)
        {
            return ApiRequest<MyEssRosterShiftActionResponse>($"/ess/{employeeId}/shift/{rosterShiftId}/swap/decline", Method.Post);
        }
        ...
        /// Decline a shift swap
        /// </remarks>
        public Task<MyEssRosterShiftActionResponse> DeclineShiftSwapAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<MyEssRosterShiftActionResponse>($"/ess/{employeeId}/shift/{rosterShiftId}/swap/decline", Method.Post, cancellationToken);
        }
        ...
        /// </remarks>
        public MyEssRosterShiftModel GetRosterShiftById(int employeeId, int rosterShiftId)
        {
            return ApiRequest<MyEssRosterShiftModel>($"/ess/{employeeId}/shift/{rosterShiftId}", Method.Get);
        }
        ...
        /// Gets the roster shift with the specified ID (as long as it is assigned to this employee).
        /// </remarks>
        public Task<MyEssRosterShiftModel> GetRosterShiftByIdAsync(int employeeId, int rosterShiftId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<MyEssRosterShiftModel>($"/ess/{employeeId}/shift/{rosterShiftId}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyEssTimesheetDataModel>($"/ess/{employeeId}/timesheet/data{ToQueryString("FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<MyEssTimesheetDataModel>($"/ess/{employeeId}/timesheet/data{ToQueryString("FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public MyRosterShiftMatchingResultModel FindMatchingClockOffRosterShift(int employeeId)
        {
            return ApiRequest<MyRosterShiftMatchingResultModel>($"/ess/{employeeId}/shift/matchingclockoff", Method.Get);
        }
        ...
        /// Note that if the time matches a shift exactly, the Shift result will also be null.
        /// </remarks>
        public Task<MyRosterShiftMatchingResultModel> FindMatchingClockOffRosterShiftAsync(int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<MyRosterShiftMatchingResultModel>($"/ess/{employeeId}/shift/matchingclockoff", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyRosterShiftMatchingResultModel>($"/ess/{employeeId}/shift/matchingclockoff{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<MyRosterShiftMatchingResultModel>($"/ess/{employeeId}/shift/matchingclockoff{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public MyRosterShiftMatchingResultModel FindMatchingClockOnRosterShift(int employeeId)
        {
            return ApiRequest<MyRosterShiftMatchingResultModel>($"/ess/{employeeId}/shift/matchingclockon", Method.Get);
        }
        ...
        /// However, if allowNotEnded is set to true, the ongoing shift will be returned.
        /// </remarks>
        public Task<MyRosterShiftMatchingResultModel> FindMatchingClockOnRosterShiftAsync(int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<MyRosterShiftMatchingResultModel>($"/ess/{employeeId}/shift/matchingclockon", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyRosterShiftMatchingResultModel>($"/ess/{employeeId}/shift/matchingclockon{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"), "allowNotEnded=" + request.AllowNotEnded)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<MyRosterShiftMatchingResultModel>($"/ess/{employeeId}/shift/matchingclockon{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"), "allowNotEnded=" + request.AllowNotEnded)}", Method.Get, cancellationToken);
        }
        ...
        /// </summary>
        /// <remarks>
        /// Downloads the specified EA Form as a PDF.
        /// </remarks>
        public byte[] DownloadEaForm(int employeeId, int documentId)
        {
            return ApiByteArrayRequest($"/ess/{employeeId}/document/eaform/{documentId}", Method.Get);
        }
        ...
        /// Downloads the specified EA Form as a PDF.
        /// </remarks>
        public Task<byte[]> DownloadEaFormAsync(int employeeId, int documentId, CancellationToken cancellationToken = default)
        {
            return ApiByteArrayRequestAsync($"/ess/{employeeId}/document/eaform/{documentId}", Method.Get, cancellationToken);
        }
        ...
        /// </summary>
        /// <remarks>
        /// Downloads the specified PCB2 Form as a PDF.
        /// </remarks>
        public byte[] DownloadPcb2Form(int employeeId, int documentId)
        {
            return ApiByteArrayRequest($"/ess/{employeeId}/document/pcb2form/{documentId}", Method.Get);
        }
        ...
        /// Downloads the specified PCB2 Form as a PDF.
        /// </remarks>
        public Task<byte[]> DownloadPcb2FormAsync(int employeeId, int documentId, CancellationToken cancellationToken = default)
        {
            return ApiByteArrayRequestAsync($"/ess/{employeeId}/document/pcb2form/{documentId}", Method.Get, cancellationToken);
        }
