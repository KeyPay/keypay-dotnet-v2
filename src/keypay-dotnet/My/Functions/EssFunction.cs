...
namespace KeyPayV2.My.Functions
{
    public interface IEssFunction
    {
        ...
        byte[] MyEssDocument_EAForm(int employeeId, int documentId);
        Task<byte[]> MyEssDocument_EAFormAsync(int employeeId, int documentId, CancellationToken cancellationToken = default);
        byte[] MyEssDocument_Pcb2Form(int employeeId, int documentId);
        Task<byte[]> MyEssDocument_Pcb2FormAsync(int employeeId, int documentId, CancellationToken cancellationToken = default);
        ...
        List<AddressAutocompleteModel> MyEssLookup_Addresses(int employeeId, int suburbId);
        Task<List<AddressAutocompleteModel>> MyEssLookup_AddressesAsync(int employeeId, int suburbId, CancellationToken cancellationToken = default);
    ...
    public class EssFunction : BaseFunction, IEssFunction
    {
        ...
        public byte[] MyEssDocument_EAForm(int employeeId, int documentId)
        {
            return ApiByteArrayRequest($"/ess/{employeeId}/document/eaform/{documentId}", Method.Get);
        }

        public Task<byte[]> MyEssDocument_EAFormAsync(int employeeId, int documentId, CancellationToken cancellationToken = default)
        {
            return ApiByteArrayRequestAsync($"/ess/{employeeId}/document/eaform/{documentId}", Method.Get, cancellationToken);
        }

        public byte[] MyEssDocument_Pcb2Form(int employeeId, int documentId)
        {
            return ApiByteArrayRequest($"/ess/{employeeId}/document/pcb2form/{documentId}", Method.Get);
        }

        public Task<byte[]> MyEssDocument_Pcb2FormAsync(int employeeId, int documentId, CancellationToken cancellationToken = default)
        {
        ...
        public List<AddressAutocompleteModel> MyEssLookup_Addresses(int employeeId, int suburbId)
        {
            return ApiRequest<List<AddressAutocompleteModel>>($"/ess/{employeeId}/lookup/addresses/{suburbId}", Method.Get);
        }

        public Task<List<AddressAutocompleteModel>> MyEssLookup_AddressesAsync(int employeeId, int suburbId, CancellationToken cancellationToken = default)
        {
