...
using KeyPayV2.My.Models.EmployeeExpenseRequest;
...
namespace KeyPayV2.My.Functions
{
    ...
    public class EmployeeExpenseRequestFunction : BaseFunction, IEmployeeExpenseRequestFunction
    {
        ...
        /// </remarks>
        public ExpenseRequestResponseModel CreateExpenseRequest(int businessId, int employeeId, ExpenseRequestEditModel model)
        {
            return ApiRequest<ExpenseRequestResponseModel,ExpenseRequestEditModel>($"/business/{businessId}/employee/{employeeId}/expenserequest", model, Method.Post);
        }
        ...
        /// Creates a new expense request for this employee.
        /// </remarks>
        public Task<ExpenseRequestResponseModel> CreateExpenseRequestAsync(int businessId, int employeeId, ExpenseRequestEditModel model, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<ExpenseRequestResponseModel,ExpenseRequestEditModel>($"/business/{businessId}/employee/{employeeId}/expenserequest", model, Method.Post, cancellationToken);
        }
        ...
        /// </remarks>
        public ExpenseRequestResponseModel UpdateExpenseRequest(int businessId, int employeeId, int expenseRequestId, ExpenseRequestEditModel model)
        {
            return ApiRequest<ExpenseRequestResponseModel,ExpenseRequestEditModel>($"/business/{businessId}/employee/{employeeId}/expenserequest/{expenseRequestId}", model, Method.Put);
        }
        ...
        /// Updates the expense request with the specified ID.
        /// </remarks>
        public Task<ExpenseRequestResponseModel> UpdateExpenseRequestAsync(int businessId, int employeeId, int expenseRequestId, ExpenseRequestEditModel model, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<ExpenseRequestResponseModel,ExpenseRequestEditModel>($"/business/{businessId}/employee/{employeeId}/expenserequest/{expenseRequestId}", model, Method.Put, cancellationToken);
        }
