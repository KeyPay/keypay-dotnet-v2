...
namespace KeyPayV2.My.Functions
{
    public interface IManagerFunction
    {
        ...
        List<MyAvailableBusinessModel> ListBusinesses();
        Task<List<MyAvailableBusinessModel>> ListBusinessesAsync(CancellationToken cancellationToken = default);
        ...
        MyManagerRosterDataModel ManageRosterData(int businessId);
        Task<MyManagerRosterDataModel> ManageRosterDataAsync(int businessId, CancellationToken cancellationToken = default);
        MyManagerRosterDataModel ManageRosterData(int businessId, ManageRosterDataQueryModel request);
        Task<MyManagerRosterDataModel> ManageRosterDataAsync(int businessId, ManageRosterDataQueryModel request, CancellationToken cancellationToken = default);
        ...
        MyTimesheetReferenceData GetTimesheetReferenceData(int businessId, int employeeId);
        Task<MyTimesheetReferenceData> GetTimesheetReferenceDataAsync(int businessId, int employeeId, CancellationToken cancellationToken = default);
    ...
    public class ManagerFunction : BaseFunction, IManagerFunction
    {
        ...
        {
            return ApiRequest<List<MyEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<MyEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<MyEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<MyEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<MyRosterShiftGenerateTimesheetModel>>($"/business/{businessId}/manager/rostershift", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<MyRosterShiftGenerateTimesheetModel>>($"/business/{businessId}/manager/rostershift", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequestAsync<List<MyRosterShiftGenerateTimesheetModel>>($"/business/{businessId}/manager/rostershift{ToQueryString("FromDate=" + request.FromDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ToDate=" + request.ToDate.ToString("yyyy-MM-ddTHH:mm:ss"), "ShiftStatus=" + request.ShiftStatus, QsArr("ShiftStatuses", request.ShiftStatuses?.Select(x => x.ToString())), QsArr("SelectedLocations", request.SelectedLocations?.Select(x => x.ToString())), QsArr("SelectedEmployees", request.SelectedEmployees?.Select(x => x.ToString())), QsArr("SelectedRoles", request.SelectedRoles?.Select(x => x.ToString())), "EmployeeId=" + request.EmployeeId, "LocationId=" + request.LocationId, "EmployeeGroupId=" + request.EmployeeGroupId, "UnassignedShiftsOnly=" + request.UnassignedShiftsOnly, "SelectAllRoles=" + request.SelectAllRoles, "ExcludeShiftsOverlappingFromDate=" + request.ExcludeShiftsOverlappingFromDate, "PageSize=" + request.PageSize, "CurrentPage=" + request.CurrentPage, "IncludeWarnings=" + request.IncludeWarnings)}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift", shiftModel, Method.Post);
        }
        ...
        {
            return ApiRequestAsync<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift", shiftModel, Method.Post, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift{ToQueryString("publish=" + request.Publish)}", shiftModel, Method.Post);
        }
        ...
        {
            return ApiRequestAsync<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift{ToQueryString("publish=" + request.Publish)}", shiftModel, Method.Post, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}", shiftModel, Method.Put);
        }
        ...
        {
            return ApiRequestAsync<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}", shiftModel, Method.Put, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}{ToQueryString("publish=" + request.Publish, "clearBreaks=" + request.ClearBreaks)}", shiftModel, Method.Put);
        }
        ...
        {
            return ApiRequestAsync<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}{ToQueryString("publish=" + request.Publish, "clearBreaks=" + request.ClearBreaks)}", shiftModel, Method.Put, cancellationToken);
        }
        ...
        /// </remarks>
        public MyManagerRosterDataModel ManageRosterData(int businessId)
        {
            return ApiRequest<MyManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage", Method.Get);
        }
        ...
        /// employee unavailablity, and leave requests.
        /// </remarks>
        public Task<MyManagerRosterDataModel> ManageRosterDataAsync(int businessId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<MyManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage{ToQueryString("Date=" + request.Date.ToString("yyyy-MM-ddTHH:mm:ss"), "EmployeeId=" + request.EmployeeId, "LocationId=" + request.LocationId, "RoleId=" + request.RoleId, "IncludeCosts=" + request.IncludeCosts, "IncludeSubLocations=" + request.IncludeSubLocations)}", Method.Get);
        }
        ...
        {
            return ApiRequest<MyRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<MyRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff{ToQueryString("kioskId=" + request.KioskId, "dateUtc=" + request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<MyRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff{ToQueryString("kioskId=" + request.KioskId, "dateUtc=" + request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<MyRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon{ToQueryString("kioskId=" + request.KioskId, "dateUtc=" + request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<MyRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon{ToQueryString("kioskId=" + request.KioskId, "dateUtc=" + request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
