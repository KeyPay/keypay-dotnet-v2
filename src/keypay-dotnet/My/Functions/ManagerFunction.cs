...
namespace KeyPayV2.My.Functions
{
    ...
    public class ManagerFunction : BaseFunction, IManagerFunction
    {
        ...
        {
            return ApiRequest<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}?publish={request.Publish}&clearBreaks={request.ClearBreaks}", shiftModel, Method.Put);
        }
        ...
        {
            return ApiRequestAsync<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}?publish={request.Publish}&clearBreaks={request.ClearBreaks}", shiftModel, Method.Put, cancellationToken);
        }
        ...
        {
            return ApiRequest<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift?publish={request.Publish}", shiftModel, Method.Post);
        }
        ...
        {
            return ApiRequestAsync<MyEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift?publish={request.Publish}", shiftModel, Method.Post, cancellationToken);
        }
