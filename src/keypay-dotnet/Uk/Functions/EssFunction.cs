...
namespace KeyPayV2.Uk.Functions
{
    public interface IEssFunction
    {
        ...
        List<AddressAutocompleteModel> UkEssLookup_Addresses(int employeeId, int suburbId);
        Task<List<AddressAutocompleteModel>> UkEssLookup_AddressesAsync(int employeeId, int suburbId, CancellationToken cancellationToken = default);
    ...
    public class EssFunction : BaseFunction, IEssFunction
    {
        ...
        public List<AddressAutocompleteModel> UkEssLookup_Addresses(int employeeId, int suburbId)
        {
            return ApiRequest<List<AddressAutocompleteModel>>($"/ess/{employeeId}/lookup/addresses/{suburbId}", Method.Get);
        }

        public Task<List<AddressAutocompleteModel>> UkEssLookup_AddressesAsync(int employeeId, int suburbId, CancellationToken cancellationToken = default)
        {
