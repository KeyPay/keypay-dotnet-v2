...
namespace KeyPayV2.Uk.Functions
{
    public interface IEssFunction
    {
        ...
        void UkEssLookup_Addresses(int employeeId, int suburbId);
        Task UkEssLookup_AddressesAsync(int employeeId, int suburbId, CancellationToken cancellationToken = default);
