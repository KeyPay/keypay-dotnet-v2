...
namespace KeyPayV2.Uk.Functions
{
    public class ManagerFunction : BaseFunction
    {
        ...
        {
            return ApiRequest<UkTimesheetReferenceData>($"/business/{businessId}/manager/{employeeId}/timesheet/reference");
        }
        ...
        {
            return ApiRequest<UkTimeAndAttendanceLookupDataModel>($"/business/{businessId}/manager/kiosk/{kioskId}/lookupdata/{employeeId}");
        }
        ...
        {
            return ApiRequest<UkRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff?kioskId={request.KioskId}&dateUtc={request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss")}");
        }
        ...
        {
            return ApiRequest<UkRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon?kioskId={request.KioskId}&dateUtc={request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss")}");
        }
        ...
        {
            return ApiRequest<List<UkEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby?localTime={request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss")}");
        }
        ...
        {
            return ApiRequest<List<UkAvailableBusinessModel>>($"/manager/security/businesses");
        }
    }
}
