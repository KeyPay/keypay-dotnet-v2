...
namespace KeyPayV2.Uk.Functions
{
    public class ManagerFunction : BaseFunction
    {
        ...
        /// details provided.
        /// </remarks>
        public Task InitiateEmployeeSelfServiceOnboardingAsync(int businessId, InitiateEmployeeOnboardingApiModel model, CancellationToken cancellationToken = default)
        {
