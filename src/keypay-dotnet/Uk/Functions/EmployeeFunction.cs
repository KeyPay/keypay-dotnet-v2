...
namespace KeyPayV2.Uk.Functions
{
    public interface IEmployeeFunction
    {
        ...
        UkSmpDataApiModel GetStatutoryMaternityLeavePeriodData(int businessId, int employeeId);
        ...
        UkSmpDataApiResponseModel UpdateStatutoryNeonatalLeavePeriodData(int businessId, int employeeId, int id, UkSncpDataApiModel sncp);
        Task<UkSmpDataApiResponseModel> UpdateStatutoryNeonatalLeavePeriodDataAsync(int businessId, int employeeId, int id, UkSncpDataApiModel sncp, CancellationToken cancellationToken = default);
        ...
        EmployeeDocumentModel AttachEmployeeDocumentToStatutorySharedParentalLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutorySharedParentalLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        void UnattachEmployeeDocumentFromStatutorySharedParentalLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task UnattachEmployeeDocumentFromStatutorySharedParentalLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        EmployeeDocumentModel AttachEmployeeDocumentToStatutoryNeonatalLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryNeonatalLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        void UnattachEmployeeDocumentFromStatutoryNeonatalLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task UnattachEmployeeDocumentFromStatutoryNeonatalLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        EmployeeDocumentModel AttachEmployeeDocumentToStatutoryMaternityLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryMaternityLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        void UnattachEmployeeDocumentFromStatutoryMaternityLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task UnattachEmployeeDocumentFromStatutoryMaternityLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        void PauseStatutoryNeonatalCareLeave(int businessId, int employeeId, int id);
        Task PauseStatutoryNeonatalCareLeaveAsync(int businessId, int employeeId, int id, CancellationToken cancellationToken = default);
        ...
        EmployeeDocumentModel AttachEmployeeDocumentToStatutoryPaternityLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryPaternityLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        void UnattachEmployeeDocumentFromStatutoryPaternityLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task UnattachEmployeeDocumentFromStatutoryPaternityLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        ...
        EmployeeDocumentModel AttachEmployeeDocumentToStatutoryAdoptionLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryAdoptionLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        void UnattachEmployeeDocumentFromStatutoryAdoptionLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task UnattachEmployeeDocumentFromStatutoryAdoptionLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        ...
        EmployeeDocumentModel AttachEmployeeDocumentToStatutoryParentalBereavementLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryParentalBereavementLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
        void UnattachEmployeeDocumentFromStatutoryParentalBereavementLeave(int businessId, int employeeId, int id, int employeeDocumentId);
        Task UnattachEmployeeDocumentFromStatutoryParentalBereavementLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default);
    ...
    public class EmployeeFunction : BaseFunction, IEmployeeFunction
    {
        ...
        /// </summary>
        public UkNationalInsuranceBackCalculationModel ApplyNationalInsuranceBackCalculation(int businessId, int employeeId, UkApplyNationalInsuranceBackCalculationRequestModel request)
        {
            return ApiRequest<UkNationalInsuranceBackCalculationModel,UkApplyNationalInsuranceBackCalculationRequestModel>($"/business/{businessId}/employee/{employeeId}/nationalinsurancebackcalculation", request, Method.Post);
        }
        ...
        /// Gets the Statutory Maternity Leave period data for a specific employee
        /// </remarks>
        public UkSmpDataApiModel GetStatutoryMaternityLeavePeriodData(int businessId, int employeeId)
        {
            return ApiRequest<UkSmpDataApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/smp", Method.Get);
        }
        ...
        /// Gets the Statutory Maternity Leave period data for a specific employee
        /// </remarks>
        public Task<UkSmpDataApiModel> GetStatutoryMaternityLeavePeriodDataAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UkSmpDataApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/smp", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public UkShppDataApiModel GetStatutorySharedParentalLeavePeriodData(int businessId, int employeeId)
        {
            return ApiRequest<UkShppDataApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/shpp", Method.Get);
        }
        ...
        /// Gets the Statutory Shared Parental Leave period data for a specific employee
        /// </remarks>
        public Task<UkShppDataApiModel> GetStatutorySharedParentalLeavePeriodDataAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UkShppDataApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/shpp", Method.Get, cancellationToken);
        }
        ...
        /// </summary>
        /// <remarks>
        /// Updates a Statutory Neonatal Leave period for an employee
        /// </remarks>
        public UkSmpDataApiResponseModel UpdateStatutoryNeonatalLeavePeriodData(int businessId, int employeeId, int id, UkSncpDataApiModel sncp)
        {
            return ApiRequest<UkSmpDataApiResponseModel,UkSncpDataApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncp/{id}", sncp, Method.Put);
        }
        ...
        /// Updates a Statutory Neonatal Leave period for an employee
        /// </remarks>
        public Task<UkSmpDataApiResponseModel> UpdateStatutoryNeonatalLeavePeriodDataAsync(int businessId, int employeeId, int id, UkSncpDataApiModel sncp, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UkSmpDataApiResponseModel,UkSncpDataApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncp/{id}", sncp, Method.Put, cancellationToken);
        }
        ...
        /// </remarks>
        public UkSncpCalcApiModel CalculateStatutoryNeonatalLeavePeriodData(int businessId, int employeeId)
        {
            return ApiRequest<UkSncpCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncpcalc", Method.Get);
        }
        ...
        /// Gets the Statutory Neonatal Leave period data for a specific employee including information about payments already made and pending
        /// </remarks>
        public Task<UkSncpCalcApiModel> CalculateStatutoryNeonatalLeavePeriodDataAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UkSncpCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncpcalc", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public UkSmpCalcApiModel CalculateStatutorySharedParentalLeavePeriodData(int businessId, int employeeId)
        {
            return ApiRequest<UkSmpCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/shppcalc", Method.Get);
        }
        ...
        /// Gets the Statutory Shared Parental Leave period data for a specific employee including information about payments already made and pending
        /// </remarks>
        public Task<UkSmpCalcApiModel> CalculateStatutorySharedParentalLeavePeriodDataAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UkSmpCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/shppcalc", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public UkSppCalcApiModel CalculateStatutoryPaternityLeavePeriodData(int businessId, int employeeId)
        {
            return ApiRequest<UkSppCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sppcalc", Method.Get);
        }
        ...
        /// Gets the Statutory Paternity Leave period data for a specific employee including information about payments already made and pending
        /// </remarks>
        public Task<UkSppCalcApiModel> CalculateStatutoryPaternityLeavePeriodDataAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UkSppCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sppcalc", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public UkSpbpCalcApiModel CalculateStatutoryParentalBereavementLeavePeriodData(int businessId, int employeeId)
        {
            return ApiRequest<UkSpbpCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/spbpcalc", Method.Get);
        }
        ...
        /// Gets the Statutory Parental Bereavement Leave period data for a specific employee including information about payments already made and pending
        /// </remarks>
        public Task<UkSpbpCalcApiModel> CalculateStatutoryParentalBereavementLeavePeriodDataAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UkSpbpCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/spbpcalc", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public UkSapCalcApiModel CalculateStatutoryAdoptionLeavePeriodData(int businessId, int employeeId)
        {
            return ApiRequest<UkSapCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sapcalc", Method.Get);
        }
        ...
        /// Gets the Statutory Adoption Leave period data for a specific employee including information about payments already made and pending
        /// </remarks>
        public Task<UkSapCalcApiModel> CalculateStatutoryAdoptionLeavePeriodDataAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<UkSapCalcApiModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sapcalc", Method.Get, cancellationToken);
        }
        ...
        /// </summary>
        public EmployeeDocumentModel AttachEmployeeDocumentToStatutorySharedParentalLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            return ApiRequest<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/shpp/{id}/employeedocument/{employeeDocumentId}", Method.Put);
        }

        /// <summary>
        /// Attach Employee Document to Statutory Shared Parental Leave
        /// </summary>
        public Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutorySharedParentalLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/shpp/{id}/employeedocument/{employeeDocumentId}", Method.Put, cancellationToken);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Shared Parental Leave
        /// </summary>
        public void UnattachEmployeeDocumentFromStatutorySharedParentalLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            ApiRequest($"/business/{businessId}/employee/{employeeId}/statutoryleave/shpp/{id}/employeedocument/{employeeDocumentId}", Method.Delete);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Shared Parental Leave
        /// </summary>
        public Task UnattachEmployeeDocumentFromStatutorySharedParentalLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync($"/business/{businessId}/employee/{employeeId}/statutoryleave/shpp/{id}/employeedocument/{employeeDocumentId}", Method.Delete, cancellationToken);
        }

        /// <summary>
        /// Attach Employee Document to Statutory Neonatal Leave
        /// </summary>
        public EmployeeDocumentModel AttachEmployeeDocumentToStatutoryNeonatalLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            return ApiRequest<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncp/{id}/employeedocument/{employeeDocumentId}", Method.Put);
        }

        /// <summary>
        /// Attach Employee Document to Statutory Neonatal Leave
        /// </summary>
        public Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryNeonatalLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncp/{id}/employeedocument/{employeeDocumentId}", Method.Put, cancellationToken);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Neonatal Leave
        /// </summary>
        public void UnattachEmployeeDocumentFromStatutoryNeonatalLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            ApiRequest($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncp/{id}/employeedocument/{employeeDocumentId}", Method.Delete);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Neonatal Leave
        /// </summary>
        public Task UnattachEmployeeDocumentFromStatutoryNeonatalLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncp/{id}/employeedocument/{employeeDocumentId}", Method.Delete, cancellationToken);
        }

        /// <summary>
        /// Attach Employee Document to Statutory Maternity Leave
        /// </summary>
        public EmployeeDocumentModel AttachEmployeeDocumentToStatutoryMaternityLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            return ApiRequest<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/smp/{id}/employeedocument/{employeeDocumentId}", Method.Put);
        }

        /// <summary>
        /// Attach Employee Document to Statutory Maternity Leave
        /// </summary>
        public Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryMaternityLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/smp/{id}/employeedocument/{employeeDocumentId}", Method.Put, cancellationToken);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Maternity Leave
        /// </summary>
        public void UnattachEmployeeDocumentFromStatutoryMaternityLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            ApiRequest($"/business/{businessId}/employee/{employeeId}/statutoryleave/smp/{id}/employeedocument/{employeeDocumentId}", Method.Delete);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Maternity Leave
        /// </summary>
        public Task UnattachEmployeeDocumentFromStatutoryMaternityLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync($"/business/{businessId}/employee/{employeeId}/statutoryleave/smp/{id}/employeedocument/{employeeDocumentId}", Method.Delete, cancellationToken);
        }

        /// <summary>
        /// Pause Statutory Neonatal Care Leave
        /// </summary>
        public void PauseStatutoryNeonatalCareLeave(int businessId, int employeeId, int id)
        {
            ApiRequest($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncp/{id}/paused", Method.Put);
        }

        /// <summary>
        /// Pause Statutory Neonatal Care Leave
        /// </summary>
        public Task PauseStatutoryNeonatalCareLeaveAsync(int businessId, int employeeId, int id, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync($"/business/{businessId}/employee/{employeeId}/statutoryleave/sncp/{id}/paused", Method.Put, cancellationToken);
        }
        ...
        /// </summary>
        public EmployeeDocumentModel AttachEmployeeDocumentToStatutoryPaternityLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            return ApiRequest<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/spp/{id}/employeedocument/{employeeDocumentId}", Method.Put);
        }

        /// <summary>
        /// Attach Employee Document to Statutory Paternity Leave
        /// </summary>
        public Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryPaternityLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/spp/{id}/employeedocument/{employeeDocumentId}", Method.Put, cancellationToken);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Paternity Leave
        /// </summary>
        public void UnattachEmployeeDocumentFromStatutoryPaternityLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            ApiRequest($"/business/{businessId}/employee/{employeeId}/statutoryleave/spp/{id}/employeedocument/{employeeDocumentId}", Method.Delete);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Paternity Leave
        /// </summary>
        public Task UnattachEmployeeDocumentFromStatutoryPaternityLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync($"/business/{businessId}/employee/{employeeId}/statutoryleave/spp/{id}/employeedocument/{employeeDocumentId}", Method.Delete, cancellationToken);
        }
        ...
        /// </summary>
        public EmployeeDocumentModel AttachEmployeeDocumentToStatutoryAdoptionLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            return ApiRequest<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sap/{id}/employeedocument/{employeeDocumentId}", Method.Put);
        }

        /// <summary>
        /// Attach Employee Document to Statutory Adoption Leave
        /// </summary>
        public Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryAdoptionLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/sap/{id}/employeedocument/{employeeDocumentId}", Method.Put, cancellationToken);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Adoption Leave
        /// </summary>
        public void UnattachEmployeeDocumentFromStatutoryAdoptionLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            ApiRequest($"/business/{businessId}/employee/{employeeId}/statutoryleave/sap/{id}/employeedocument/{employeeDocumentId}", Method.Delete);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Adoption Leave
        /// </summary>
        public Task UnattachEmployeeDocumentFromStatutoryAdoptionLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync($"/business/{businessId}/employee/{employeeId}/statutoryleave/sap/{id}/employeedocument/{employeeDocumentId}", Method.Delete, cancellationToken);
        }
        ...
        /// </summary>
        public EmployeeDocumentModel AttachEmployeeDocumentToStatutoryParentalBereavementLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            return ApiRequest<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/spbp/{id}/employeedocument/{employeeDocumentId}", Method.Put);
        }

        /// <summary>
        /// Attach Employee Document to Statutory Parental Bereavement Leave
        /// </summary>
        public Task<EmployeeDocumentModel> AttachEmployeeDocumentToStatutoryParentalBereavementLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<EmployeeDocumentModel>($"/business/{businessId}/employee/{employeeId}/statutoryleave/spbp/{id}/employeedocument/{employeeDocumentId}", Method.Put, cancellationToken);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Parental Bereavement Leave
        /// </summary>
        public void UnattachEmployeeDocumentFromStatutoryParentalBereavementLeave(int businessId, int employeeId, int id, int employeeDocumentId)
        {
            ApiRequest($"/business/{businessId}/employee/{employeeId}/statutoryleave/spbp/{id}/employeedocument/{employeeDocumentId}", Method.Delete);
        }

        /// <summary>
        /// Unattach Employee Document from Statutory Parental Bereavement Leave
        /// </summary>
        public Task UnattachEmployeeDocumentFromStatutoryParentalBereavementLeaveAsync(int businessId, int employeeId, int id, int employeeDocumentId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync($"/business/{businessId}/employee/{employeeId}/statutoryleave/spbp/{id}/employeedocument/{employeeDocumentId}", Method.Delete, cancellationToken);
        }
