...
namespace KeyPayV2.Sg.Functions
{
    ...
    public class EmployeeFunction : BaseFunction, IEmployeeFunction
    {
        ...
        {
            return ApiRequest<List<SgUnstructuredEmployeeModel>>($"/business/{businessId}/employee/unstructured?PayScheduleId={request.PayScheduleId}&LocationId={request.LocationId}&options={request.Options}{ODataQuery.ToQueryString(oDataQuery, "&")}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<SgUnstructuredEmployeeModel>>($"/business/{businessId}/employee/unstructured?PayScheduleId={request.PayScheduleId}&LocationId={request.LocationId}&options={request.Options}{ODataQuery.ToQueryString(oDataQuery, "&")}", Method.Get, cancellationToken);
        }
