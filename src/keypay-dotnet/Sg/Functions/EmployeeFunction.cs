...
namespace KeyPayV2.Sg.Functions
{
    ...
    public class EmployeeFunction : BaseFunction, IEmployeeFunction
    {
        ...
        {
            return ApiRequest<EmployeeUpdateResponseModel,SgUnstructuredEmployeeModel>($"/business/{businessId}/employee/unstructured{ToQueryString("matchType=" + request.MatchType)}", model, Method.Post);
        }
        ...
        {
            return ApiRequestAsync<EmployeeUpdateResponseModel,SgUnstructuredEmployeeModel>($"/business/{businessId}/employee/unstructured{ToQueryString("matchType=" + request.MatchType)}", model, Method.Post, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<SgUnstructuredEmployeeModel>>($"/business/{businessId}/employee/unstructured{ToQueryString("PayScheduleId=" + request.PayScheduleId, "LocationId=" + request.LocationId, "options=" + request.Options)}{ODataQuery.ToQueryString(oDataQuery, "&")}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<SgUnstructuredEmployeeModel>>($"/business/{businessId}/employee/unstructured{ToQueryString("PayScheduleId=" + request.PayScheduleId, "LocationId=" + request.LocationId, "options=" + request.Options)}{ODataQuery.ToQueryString(oDataQuery, "&")}", Method.Get, cancellationToken);
        }
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public List<SgUnstructuredEmployeeModel> ListEmployees(int businessId, ODataQuery oDataQuery = null)
        {
        ...
        /// This operation supports OData queries (only $filter, $orderby, $top, $skip).
        /// </remarks>
        public Task<List<SgUnstructuredEmployeeModel>> ListEmployeesAsync(int businessId, ODataQuery oDataQuery = null, CancellationToken cancellationToken = default)
        {
