...
namespace KeyPayV2.Sg.Functions
{
    public interface IManagerFunction
    {
        ...
        IndividualTimesheetLineModel CreateKioskTimesheetLine(int businessId, IndividualTimesheetLineModel request);
        Task<IndividualTimesheetLineModel> CreateKioskTimesheetLineAsync(int businessId, IndividualTimesheetLineModel request, CancellationToken cancellationToken = default);
        IndividualTimesheetLineModel CreateTimesheetLine(int businessId, IndividualTimesheetLineModel request);
        Task<IndividualTimesheetLineModel> CreateTimesheetLineAsync(int businessId, IndividualTimesheetLineModel request, CancellationToken cancellationToken = default);
        IndividualTimesheetLineModel UpdateCommentsInATimesheet(int businessId, string timesheetLineId, TimesheetLineCommentsModel request);
        Task<IndividualTimesheetLineModel> UpdateCommentsInATimesheetAsync(int businessId, string timesheetLineId, TimesheetLineCommentsModel request, CancellationToken cancellationToken = default);
        IndividualTimesheetLineModel UpdateKioskTimesheetLine(int businessId, int timesheetLineId, IndividualTimesheetLineModel request);
        Task<IndividualTimesheetLineModel> UpdateKioskTimesheetLineAsync(int businessId, int timesheetLineId, IndividualTimesheetLineModel request, CancellationToken cancellationToken = default);
        IndividualTimesheetLineModel UpdateTimesheetLine(int businessId, int timesheetLineId, IndividualTimesheetLineModel request);
        Task<IndividualTimesheetLineModel> UpdateTimesheetLineAsync(int businessId, int timesheetLineId, IndividualTimesheetLineModel request, CancellationToken cancellationToken = default);
        ...
        List<SgAvailableBusinessModel> ListBusinesses();
        Task<List<SgAvailableBusinessModel>> ListBusinessesAsync(CancellationToken cancellationToken = default);
        ...
        List<SgTimeAndAttendanceShiftModel> Shifts(int businessId, GetShiftsModel model);
        Task<List<SgTimeAndAttendanceShiftModel>> ShiftsAsync(int businessId, GetShiftsModel model, CancellationToken cancellationToken = default);
        ...
        SgEssRosterShiftModel CreateRosterShift(int businessId, RosterShiftEditModel shiftModel);
        ...
        SgManagerRosterDataModel ManageRosterData(int businessId);
        Task<SgManagerRosterDataModel> ManageRosterDataAsync(int businessId, CancellationToken cancellationToken = default);
        SgManagerRosterDataModel ManageRosterData(int businessId, ManageRosterDataQueryModel request);
        Task<SgManagerRosterDataModel> ManageRosterDataAsync(int businessId, ManageRosterDataQueryModel request, CancellationToken cancellationToken = default);
        ...
        SgRosterShiftMatchingResultModel FindMatchingClockOnRosterShift(int businessId, int employeeId);
        ...
        SgTimeAndAttendanceLookupDataModel GetEmployeeLookupData(int businessId, int employeeId, int kioskId);
        Task<SgTimeAndAttendanceLookupDataModel> GetEmployeeLookupDataAsync(int businessId, int employeeId, int kioskId, CancellationToken cancellationToken = default);
        SgTimesheetReferenceData GetTimesheetReferenceData(int businessId, int employeeId);
        ...
        Task InitiateEmployeeSelfSetupAsync(int businessId, SgInitiateEmployeeOnboardingApiModel model, CancellationToken cancellationToken = default);
    ...
    public class ManagerFunction : BaseFunction, IManagerFunction
    {
        ...
        /// </remarks>
        public IndividualTimesheetLineModel CreateKioskTimesheetLine(int businessId, IndividualTimesheetLineModel request)
        {
            return ApiRequest<IndividualTimesheetLineModel,IndividualTimesheetLineModel>($"/business/{businessId}/manager/kiosk/timesheet", request, Method.Post);
        }
        ...
        /// IMPORTANT NOTICE: If units are specified the start and end time will be changed to midnight
        /// </remarks>
        public Task<IndividualTimesheetLineModel> CreateKioskTimesheetLineAsync(int businessId, IndividualTimesheetLineModel request, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<IndividualTimesheetLineModel,IndividualTimesheetLineModel>($"/business/{businessId}/manager/kiosk/timesheet", request, Method.Post, cancellationToken);
        }
        ...
        /// </remarks>
        public IndividualTimesheetLineModel UpdateCommentsInATimesheet(int businessId, string timesheetLineId, TimesheetLineCommentsModel request)
        {
            return ApiRequest<IndividualTimesheetLineModel,TimesheetLineCommentsModel>($"/business/{businessId}/manager/kiosk/timesheetcomments/{timesheetLineId}", request, Method.Put);
        }
        ...
        /// Update an individual timesheet line with comments
        /// </remarks>
        public Task<IndividualTimesheetLineModel> UpdateCommentsInATimesheetAsync(int businessId, string timesheetLineId, TimesheetLineCommentsModel request, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<IndividualTimesheetLineModel,TimesheetLineCommentsModel>($"/business/{businessId}/manager/kiosk/timesheetcomments/{timesheetLineId}", request, Method.Put, cancellationToken);
        }
        ...
        /// IMPORTANT NOTICE: If units are specified the start and end time will be changed to midnight
        /// </remarks>
        public IndividualTimesheetLineModel UpdateKioskTimesheetLine(int businessId, int timesheetLineId, IndividualTimesheetLineModel request)
        {
            return ApiRequest<IndividualTimesheetLineModel,IndividualTimesheetLineModel>($"/business/{businessId}/manager/kiosk/timesheet/{timesheetLineId}", request, Method.Put);
        }
        ...
        /// IMPORTANT NOTICE: If units are specified the start and end time will be changed to midnight
        /// </remarks>
        public Task<IndividualTimesheetLineModel> UpdateKioskTimesheetLineAsync(int businessId, int timesheetLineId, IndividualTimesheetLineModel request, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<IndividualTimesheetLineModel,IndividualTimesheetLineModel>($"/business/{businessId}/manager/kiosk/timesheet/{timesheetLineId}", request, Method.Put, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<SgEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<SgEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<SgEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<SgEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby{ToQueryString("localTime=" + request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<SgRosterShiftGenerateTimesheetModel>>($"/business/{businessId}/manager/rostershift", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<SgRosterShiftGenerateTimesheetModel>>($"/business/{businessId}/manager/rostershift", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public ManagerLeaveEstimate EstimateLeaveHours(int businessId, int employeeId)
        {
            return ApiRequest<ManagerLeaveEstimate>($"/business/{businessId}/manager/{employeeId}/leaverequest/estimate", Method.Get);
        }
        ...
        /// Estimates the number of hours of leave required based on date and leave category.
        /// </remarks>
        public Task<ManagerLeaveEstimate> EstimateLeaveHoursAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<ManagerLeaveEstimate>($"/business/{businessId}/manager/{employeeId}/leaverequest/estimate", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public SgEssRosterShiftModel CreateRosterShift(int businessId, RosterShiftEditModel shiftModel)
        {
            return ApiRequest<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift", shiftModel, Method.Post);
        }
        ...
        /// Create or update an individual roster shift
        /// </remarks>
        public Task<SgEssRosterShiftModel> CreateRosterShiftAsync(int businessId, RosterShiftEditModel shiftModel, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift", shiftModel, Method.Post, cancellationToken);
        }
        ...
        /// Create or update an individual roster shift
        /// </remarks>
        public SgEssRosterShiftModel CreateRosterShift(int businessId, RosterShiftEditModel shiftModel, CreateRosterShiftQueryModel request)
        {
            return ApiRequest<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift{ToQueryString("publish=" + request.Publish)}", shiftModel, Method.Post);
        }
        ...
        {
            return ApiRequestAsync<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift{ToQueryString("publish=" + request.Publish)}", shiftModel, Method.Post, cancellationToken);
        }
        ...
        {
            return ApiRequest<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}", shiftModel, Method.Put);
        }
        ...
        {
            return ApiRequestAsync<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}", shiftModel, Method.Put, cancellationToken);
        }
        ...
        {
            return ApiRequest<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}{ToQueryString("publish=" + request.Publish, "clearBreaks=" + request.ClearBreaks)}", shiftModel, Method.Put);
        }
        ...
        {
            return ApiRequestAsync<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}{ToQueryString("publish=" + request.Publish, "clearBreaks=" + request.ClearBreaks)}", shiftModel, Method.Put, cancellationToken);
        }
        ...
        /// </remarks>
        public SgManagerRosterDataModel ManageRosterData(int businessId)
        {
            return ApiRequest<SgManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage", Method.Get);
        }
        ...
        /// employee unavailablity, and leave requests.
        /// </remarks>
        public Task<SgManagerRosterDataModel> ManageRosterDataAsync(int businessId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<SgManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<SgManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage{ToQueryString("Date=" + request.Date.ToString("yyyy-MM-ddTHH:mm:ss"), "EmployeeId=" + request.EmployeeId, "LocationId=" + request.LocationId, "RoleId=" + request.RoleId, "IncludeCosts=" + request.IncludeCosts, "IncludeSubLocations=" + request.IncludeSubLocations)}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<SgManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage{ToQueryString("Date=" + request.Date.ToString("yyyy-MM-ddTHH:mm:ss"), "EmployeeId=" + request.EmployeeId, "LocationId=" + request.LocationId, "RoleId=" + request.RoleId, "IncludeCosts=" + request.IncludeCosts, "IncludeSubLocations=" + request.IncludeSubLocations)}", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public SgRosterShiftMatchingResultModel FindMatchingClockOffRosterShift(int businessId, int employeeId)
        {
            return ApiRequest<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff", Method.Get);
        }
        ...
        /// Note that if the time matches a shift exactly, the Shift result will also be null.
        /// </remarks>
        public Task<SgRosterShiftMatchingResultModel> FindMatchingClockOffRosterShiftAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff{ToQueryString("kioskId=" + request.KioskId, "dateUtc=" + request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff{ToQueryString("kioskId=" + request.KioskId, "dateUtc=" + request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
        ...
        /// Note that if the time matches a shift exactly, the Shift result will also be null.
        /// </remarks>
        public SgRosterShiftMatchingResultModel FindMatchingClockOnRosterShift(int businessId, int employeeId)
        {
            return ApiRequest<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon", Method.Get);
        }
        ...
        /// Note that if the time matches a shift exactly, the Shift result will also be null.
        /// </remarks>
        public Task<SgRosterShiftMatchingResultModel> FindMatchingClockOnRosterShiftAsync(int businessId, int employeeId, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon{ToQueryString("kioskId=" + request.KioskId, "dateUtc=" + request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon{ToQueryString("kioskId=" + request.KioskId, "dateUtc=" + request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss"))}", Method.Get, cancellationToken);
        }
