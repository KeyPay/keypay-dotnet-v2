...
namespace KeyPayV2.Sg.Functions
{
    ...
    public class ManagerFunction : BaseFunction, IManagerFunction
    {
        ...
        {
            return ApiRequest<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}?publish={request.Publish}&clearBreaks={request.ClearBreaks}", shiftModel, Method.Put);
        }
        ...
        {
            return ApiRequestAsync<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift/{rosterShiftId}?publish={request.Publish}&clearBreaks={request.ClearBreaks}", shiftModel, Method.Put, cancellationToken);
        }
        ...
        {
            return ApiRequest<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift?publish={request.Publish}", shiftModel, Method.Post);
        }
        ...
        {
            return ApiRequestAsync<SgEssRosterShiftModel,RosterShiftEditModel>($"/business/{businessId}/manager/rostershift?publish={request.Publish}", shiftModel, Method.Post, cancellationToken);
        }
