...
namespace KeyPayV2.Sg.Functions
{
    public class ManagerFunction : BaseFunction
    {
        ...
        /// details provided.
        /// </remarks>
        public Task InitiateEmployeeSelfServiceOnboardingAsync(int businessId, SgInitiateEmployeeOnboardingApiModel model, CancellationToken cancellationToken = default)
        {
