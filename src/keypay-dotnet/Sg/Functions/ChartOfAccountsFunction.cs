...
namespace KeyPayV2.Sg.Functions
{
    public class ChartOfAccountsFunction : BaseFunction
    {
        ...
        {
            return ApiRequest<SgChartOfAccountsModel>($"/business/{businessId}/chartofaccounts");
        }
        ...
        {
            return ApiRequest<SgChartOfAccountsLocationGroupModel>($"/business/{businessId}/chartofaccounts/location/{locationId}");
        }
